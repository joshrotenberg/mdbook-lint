...
mod tests {
    ...
    #[test]
    fn test_mdbook005_no_orphans() -> crate::error::Result<()> {
...
"#;
    ...
    #[test]
    fn test_mdbook005_detect_orphans() -> crate::error::Result<()> {
        let temp_dir = TempDir::new()?;
        let root = temp_dir.path();
...
"#;
    ...
    #[test]
    fn test_mdbook005_ignore_common_files() -> crate::error::Result<()> {
        let temp_dir = TempDir::new()?;
        let root = temp_dir.path();
...
"#;
    ...
    #[test]
    fn test_mdbook005_nested_directories() -> crate::error::Result<()> {
        let temp_dir = TempDir::new()?;
        let root = temp_dir.path();
...
"#;
    ...
    #[test]
    fn test_mdbook005_draft_chapters() -> crate::error::Result<()> {
        let temp_dir = TempDir::new()?;
        let root = temp_dir.path();
...
"#;
    ...
    #[test]
    fn test_mdbook005_non_summary_files() -> crate::error::Result<()> {
        let temp_dir = TempDir::new()?;
    ...
    #[test]
    fn test_custom_ignored_files() -> crate::error::Result<()> {
        let temp_dir = TempDir::new()?;
        let root = temp_dir.path();
