...
mod tests {
    ...
    #[test]
    fn test_mdbook002_valid_links() -> crate::error::Result<()> {
...
"#;
    ...
    #[test]
    fn test_mdbook002_invalid_links() -> crate::error::Result<()> {
        let temp_dir = TempDir::new()?;
...
"#;
    ...
    #[test]
    fn test_mdbook002_links_with_anchors() -> crate::error::Result<()> {
        let temp_dir = TempDir::new()?;
